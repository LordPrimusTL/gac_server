        ...
        <table class=" col-lg-12 table table-responsive ">
            ...
            @foreach($main_hymn as $mh)
                <tr>
                    ...
                    @endif
                    <td>
                        <a href="main/{{$mh->hymn_id}}" class="btn btn-primary l"><span class="glyphicon glyphicon-search"></span> &nbsp; View </a>
                        @if(\Illuminate\Support\Facades\Auth::check())
                            ...
                            <a href="#" onclick="getConfirmation({{$mh->hymn_id}}, 0)" class="btn btn-danger delete-hymn"  data-id="{{$mh->id}}"><span class="glyphicon glyphicon-trash"></span> &nbsp; Delete </a>
                        @endif
                    </td>
                </tr>
            @endforeach
