<nav class="navbar navbar-findcond navbar-static-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('img/logo.png')); ?>" height="60px" width="60px"/></a>
        </div>
        <div class="collapse navbar-collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo e(url('/')); ?>">Change Password</a></li>
            ...
            <form class="navbar-form pull-right" role="search">
                <a href="<?php echo e(url('/search')); ?>" class="btn btn-primary" style="background-color: white!important;">Search</a>
            </form>
        </div>
    </div>
</nav>